...
![Упс... Здесь должна быть картинка...](./docs-sourses/images/image_1.jpeg)
...
Запуск исполняемого файла в окне терминала:
...
- [**geo**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/geo.h#L5) — объявляет координаты на земной поверхности и вычисляет расстояние между ними;
- [**domain**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/domain.h#L9) — классы основных сущностей, описывают автобусы и остановки;
- [**transport_catalogue**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/transport_catalogue.h#L20) — модуль транспортного каталога;
- [**request_handler**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/request_handler.h#L8) — обрабатывает запросы. Играет роль Фасада, который упрощает взаимодействие с транспортным каталогом;
- [**renderer**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/map_renderer.h#L13) - визуализация маршрутов;
- [**graph**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/graph.h#L9) - реализация графа для построения оптимальных маршрутов;
- [**transport_router**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/transport_router.h#L8) - реализация маршрутизатора;
- [**serialization**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/serialization.h#L14) - реализация логики сериализации и десериализации базы данных;
- [**json**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/json.h#L9) — библиотека для парсинга и вывода JSON;
- [**svg**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/svg.h#L13) - библиотека SVG для построения карты маршрутов;
- [**reader**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/json_reader.h#L13) — выполняет разбор JSON-данных, построенных в ходе парсинга, и формирует массив JSON-ответов;
...
- [**Добавление маршрута в базу**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/transport_catalogue.cpp#L14);
- [**Добавление остановки в базу**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/transport_catalogue.cpp#L9);
- [**Поиск маршрута по имени**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/transport_catalogue.cpp#L37);
- [**Поиск остановки по имени**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/transport_catalogue.cpp#L42);
- [**Получение информации о маршруте**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/transport_catalogue.cpp#L47);
- [**Получение информации об остановке**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/transport_catalogue.cpp#L63);
- [**Получение ссылки на дек всех маршрутов**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/transport_catalogue.cpp#L77);
- [**Получение ссылки на дек всех остановок**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/transport_catalogue.cpp#L74);
- [**Получение отсортированного массива всех маршрутов**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/transport_catalogue.cpp#L81);
- [**Получение отсортированного массива всех остановок**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/transport_catalogue.cpp#L94);
- [**Получение значений координат всех существующих остановок**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/transport_catalogue.cpp#L107);
- [**Получение индексов маршрутов**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/transport_catalogue.cpp#L118);
- [**Получение дистанции между остановками**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/transport_catalogue.cpp#L137);
...
В файлах [*json.h*](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/main/transport-catalogue/json.h) и [*json.cpp*](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/main/transport-catalogue/json.cpp) располагается библитека для парсинга JSON.

Класс [**Node**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/json.h#L20) должен хранить значения одного из следующих типов:
...
Класс [**json::Builder**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/json_builder.h#L10), позволяющий сконструировать JSON-объект, используя цепочки вызовов методов. Этот класс основан на библиотеке JSON, описанной выше.
...
Планета Земля имеет форму геоида, но чтобы упростить вычисления, в программе она считается идеальной сферой радиусом 6371 километр. Эти допущения отражены в функции [*geo::ComputeDistance*](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/geo.h#L20). Она вычисляет географическое расстояние между двумя точками земной поверхности.
...
Класс [**SphereProjector**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/map_renderer.h#L20) проецирует точки на плоскость для этих нужд.
...
- [**graph.h**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/main/transport-catalogue/graph.h) — класс, реализующий взвешенный ориентированный граф,
- [**router.h**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/main/transport-catalogue/router.h) — класс, реализующий поиск кратчайшего пути во взвешенном ориентированном графе.
...
- Маршрутизатор — класс [**Router**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/288970d04949eaa860eadcbb0be5a3af6e7678c7/transport-catalogue/router.h#L19) — требует квадратичного относительно количества вершин объёма памяти, не считая памяти, требуемой для хранения кэша маршрутов.
...
Proto-файлы для классов транспортного справочника:
- [**graph.proto**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/main/transport-catalogue/graph.proto);
- [**map_renderer.proto**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/main/transport-catalogue/map_renderer.proto);
- [**svg.proto**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/main/transport-catalogue/svg.proto)
- [**transport_catalogue.proto**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/main/transport-catalogue/transport_catalogue.proto);
- [**transport_router.proto**](https://github.com/konstantinbelousovEC/cpp-transport-catalogue/blob/main/transport-catalogue/transport_router.proto).
